  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--sb-bg)", color: "var(--sb-cream)", position: "relative" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 48px", borderBottom: "1px solid rgba(38,34,32,0.08)", background: "#fff" }}>
        <Brand height={26} />
        <Link href="/account" title="Your account" style={{ width: 32, height: 32, borderRadius: "50%", background: "var(--sb-red)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 800, fontFamily: "var(--font-bricolage), sans-serif", textDecoration: "none" }}>
